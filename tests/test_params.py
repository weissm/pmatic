...
from pmatic.params import Parameter, ParameterINTEGER, ParameterFLOAT,\
                          ParameterSTRING,\
                          ParameterENUM # ParameterBOOL, ParameterACTION,
                          
from pmatic import utils, PMException, PMActionFailed
import lib

class TestParameterCCU2(lib.TestCCUClassWideCCU2):
...
class TestParameterFLOAT(lib.TestCCUClassWideCCU2):
    @pytest.fixture(scope="function")
    def p(self, ccu2):
        clima_regulator = list(ccu2.devices.query(device_name="Bad-Thermostat"))[0].channels[2]
...
# class TestParameterBOOL(lib.TestCCUClassWideCCU2):
    # @pytest.fixture(scope="function")
    # def p(self, ccu2):
        # switch_state_channel = list(ccu2.devices.query(device_name="Büro-Lampe"))[0].channels[1]
...
# class TestParameterACTION(TestParameterBOOL):
    # @pytest.fixture(scope="function")
    # def p(self, ccu2):
        # button0 = list(ccu2.devices.query(device_name="Büro-Schalter"))[0].switch1
...
class TestParameterINTEGER(lib.TestCCUClassWideCCU2):
    @pytest.fixture(scope="function")
    def p(self, ccu2):
        clima_vent_drive = list(ccu2.devices.query(device_name="Wohnzimmer"))[0].channels[4]
...
class TestParameterENUM(lib.TestCCUClassWideCCU2):
    @pytest.fixture(scope="function")
    def p(self, ccu2):
        clima_vent_drive = list(ccu2.devices.query(device_name="Bad-Heizung"))[0].channels[1]
...
class TestParameterSTRING(lib.TestCCUClassWideCCU2):
    @pytest.fixture(scope="function")
    def p(self, ccu2):
        trans = list(ccu2.devices.query(device_name="Schlafzimmer-Links-Heizung"))[0].channels[4]
